<template>
  <div class="class-navigation">
    <div class="class-navigation__wrapper">
      <div
        class="class-navigation__zoom-icon class-navigation__zoom-icon--left"
      >
        <svg
          viewBox="0 0 24 24"
      ...
      <div
        class="class-navigation__line-wrapper"
        ref="line"
        @mousedown="onStart"
        @touchstart="onStart"
      >
        <div class="class-navigation__line">
          <div
            class="class-navigation__fill"
            :style="{
              flexGrow: zoom,
            }"
          ></div>
          <div
            class="class-navigation__circle"
            :class="{ 'class-navigation__circle--focus': focus }"
            :style="{
              left: `${zoom * 100}%`,
            }"
          >
            <div
              class="class-navigation__inner-circle"
              :class="{ 'class-navigation__inner-circle--focus': focus }"
            ></div>
          </div>
        </div>
      </div>
      ...
      <div
        class="class-navigation__zoom-icon class-navigation__zoom-icon--right"
      >
        <svg
          viewBox="0 0 24 24"
          class="r-1re7ezh r-4qtqp9 r-yyyyoo r-1xvli5t r-dnmrzs r-bnwqim r-1plcrui r-lrvibr"
